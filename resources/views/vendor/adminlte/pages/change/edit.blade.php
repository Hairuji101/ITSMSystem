...
@section('main-content')
 <!--Form Start-->
{!! Form::model($change,['route'=> [ 'changes.update', $change->id], 'method' =>'PUT'] ) !!}
{{ csrf_field() }}
    ...
    <section class="content-header">
     ...
     <!--Cancel Button-->
     {!! Html::linkRoute('changes.show', 'Cancel', array($change->id), array('class' => 'btn btn-danger btn-m pull-right-containerl' )) !!}
    </section>
    ...
    <div class="row-md-7">   
      <div class="box box-info">
        ...
        <div class="box-body">
          ...
          <!-- /.row -->
           &nbsp;
      {{Form::submit('Save Change', array('class'=>'btn btn-success btn-lg btn-block'))}}
