...
@section('main-content')
 <!--Form Start-->
 {!! Form::open(array('route' => 'releases.store', 'data-parsley-validate'=> '')) !!}
    {{ csrf_field() }}

	<div class="container-fluid spark-screen">
    <section class="content-header">     
       <!--Cancel Button-->
       <a class="btn btn-danger btn-m pull-right-container" href="{{ route('releases.index') }}"><span class='glyphicon glyphicon-remove'></span> Cancel</a>
    </section>
    ...
    <div class="row-md-7">   
      <div class="box box-info">
        ...
        <div class="box-body">
          ...
          <!-- /.row -->
           &nbsp;
      {{Form::submit('Add Release', array('class'=>'btn btn-success btn-lg btn-block'))}}
        </div><!-- end box-body-->  
      </div><!-- end box-info-->
    </div><!-- end row-md-7-->
  </section>
