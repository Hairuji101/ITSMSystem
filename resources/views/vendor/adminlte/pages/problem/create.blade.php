...
@section('main-content')
 <!--Form Start-->
 {!! Form::open(array('route' => 'problems.store', 'data-parsley-validate'=> '')) !!}
    {{ csrf_field() }}

	<div class="container-fluid spark-screen">
    <section class="content-header">
          <!--Submit Button-->
       <button type="submit" class="btn btn-success btn-m pull-right-containerl"><i class="glyphicon glyphicon-save"></i> Create New Record</button>
       <!--Cancel Button-->
       <a class="btn btn-danger btn-m pull-right-containerl" href="{{ route('problems.index') }}"><span class='glyphicon glyphicon-remove'></span> Cancel</a>
    </section>
